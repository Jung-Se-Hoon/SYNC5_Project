		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Check_SD",
									"targetURL": "#zc501sdgw0006checksd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc501sdgw0006checksd-display": {
								"semanticObject": "zc501sdgw0006checksd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc501sd.gw0006.checksd",
									"url": sap.ui.require.toUrl("zc501sd/gw0006/checksd")
								}
							}
						}
					}
