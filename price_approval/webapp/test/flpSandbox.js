		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD-01] 판매단가 결재",
									"targetURL": "#zc501sdgw0004priceapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc501sdgw0004priceapproval-display": {
								"semanticObject": "zc501sdgw0004priceapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc501sd.gw0004.priceapproval",
									"url": sap.ui.require.toUrl("zc501sd/gw0004/priceapproval")
								}
							}
						}
					}
