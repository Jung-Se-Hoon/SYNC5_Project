		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Price_Increase",
									"targetURL": "#zc501sdcds0001priceincrease-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc501sdcds0001priceincrease-display": {
								"semanticObject": "zc501sdcds0001priceincrease",
								"action": "display",
								"description": "Price_Increase",
								"title": "Price_Increase",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc501sd.cds0001.priceincrease",
									"url": sap.ui.require.toUrl("zc501sd/cds0001/priceincrease")
								}
							}
						}
					}
